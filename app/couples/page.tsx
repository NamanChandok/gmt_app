...
export default function Home() {
  ...
  const accordianData = [
    {
      title: "💬 Emotionally Focused Couples Therapy (EFT)",
      desc: "EFT helps partners identify negative cycles and build secure, loving attachments. It supports expressing vulnerable feelings while creating a safe emotional connection.",
      button: "Learn more about EFT",
    },
    {
      title: "🫶 Gottman-Informed Couples Therapy",
      desc: "Drawn from the Gottman Method, this approach offers research-based tools to improve communication, manage conflict, and build a stronger friendship within your partnership.",
      button: "Explore the Gottman Approach",
    },
    {
      title: "🧩 Skills for Lasting Connection",
      desc: "Learn practical skills to strengthen trust, enhance emotional safety, and maintain a sense of partnership long after therapy ends.",
      button: "See How You Can Benefit",
    },
  ];
      ...
      <header className="relative w-full h-full overflow-hidden flex items-center justify-center min-h-[calc(100vh-7rem)]">
        ...
        <div className="relative z-10 text-center px-4 max-w-screen-lg">
          <p className="text-lightMain1/80 text-sm mb-3">
            Couples Counselling in Los Angeles &amp; Online
          </p>
          ...
          <p className="md:text-2xl max-w-3xl mx-auto font-medium text-lightMain1 my-4">
            Rebuild trust, deepen intimacy, and find new ways of connecting in
            Los Angeles, CA.
          </p>
      ...
      <section className="py-12 grid md:grid-cols-2 md:py-24 items-center bg-lightMain1 px-8 md:px-[calc(10%+1.25rem)] gap-6 lg:gap-12">
        <div className="space-y-4">
          <span className="inline-block rounded-lg bg-main1 px-3 py-1 text-sm text-darkMain1">
            Couples Therapy Pain Points | Los Angeles, CA
          </span>
          <h1 className="text-4xl font-bold tracking-tighter md:text-5xl">
            Feeling Disconnected, Hurt, or Stuck in Your Relationship?
          </h1>
          <p className="md:text-xl">
            Even healthy couples can struggle. Unresolved conflicts,
            communication breakdowns, or past wounds can leave you feeling
            alone, unheard, or hopeless. Couples counseling helps you rediscover
            safety, connection, and compassion - together.
          </p>
          <div className="rounded-xl text-card-foreground shadow border-l-4 bg-red-100/20 border-l-green-400 p-4">
            ...
            <p>
              Recurring disagreements may leave you feeling exhausted or
              defeated. Therapy offers tools to break harmful patterns and build
              healthier ways to disagree.
            </p>
          </div>
          <div className="rounded-xl text-card-foreground shadow border-l-4 bg-red-100/20 border-l-green-400 p-4">
            <p className="font-semibold text-lg">Loss of Trust or Betrayal</p>
            <p>
              Past betrayals can create distance and resentment. Couples therapy
              helps you safely process pain and work toward rebuilding trust.
            </p>
          </div>
          <div className="rounded-xl text-card-foreground shadow border-l-4 bg-red-100/20 border-l-green-400 p-4">
            <p className="font-semibold text-lg">
            ...
            <p>
              Emotional or physical disconnection can feel isolating. Therapy
              supports you in exploring what closeness means and how to restore
              it.
            </p>
          </div>
          <div className="rounded-xl text-card-foreground shadow border-l-4 bg-red-100/20 border-l-green-400 p-4">
            <p className="font-semibold text-lg">Life Transitions and Stress</p>
            <p>
              Parenthood, relocation, career changes, or loss can strain your
              relationship. Therapy helps you navigate these changes together as
              a team.
            </p>
          </div>
        ...
        <div className="min-h-[500px] relative h-max rounded-xl overflow-hidden">
          ...
          <div className="grid grid-cols-2 absolute bottom-0 inset-x-0 text-white bg-gradient-to-t from-slate-900/90 to-transparent p-6 gap-4">
            ...
            <p className="flex gap-2 items-center">
              ...
              Safe, Respectful Space for Both Partners
            </p>
            <p className="flex gap-2 items-center">
              <ShieldCheck className="h-5 w-5 text-green-500" />
              Over 8 Years Supporting Couples
            </p>
            <p className="flex gap-2 items-center">
      ...
      <section className="w-full py-12 md:py-24 bg-lightMain1 px-4 md:px-[calc(10%+1.25rem)]">
        <div className="mx-auto lg:mx-0 space-y-4 max-w-3xl">
          <span className="inline-block rounded-lg bg-blue-100 px-3 py-1 text-sm text-darkMain1">
            Couples Counseling &amp; Marriage Counseling | Los Angeles, CA
          </span>
          <h1 className="text-4xl font-bold tracking-tighter md:text-5xl">
            How Couples Therapy Can Help
          </h1>
          <p className="md:text-xl">
            Using evidence-based techniques like EFT and Gottman-informed
            practices, Serena helps couples build greater understanding and
        ...
        <div className="mt-8 flex w-full items-start justify-between gap-12 flex-row-reverse">
          ...
          <Image
            ...
            src="/how.jpg"
            alt="How Couples Therapy Can Help"
            width={500}
            height={500}
          />
        </div>
